...
# JESSY PERSONALITY
# -------------------------
def jesse(text: str) -> str:
    prefixes = ["Yo.", "Listen.", "Alright.", "Yo man,", "Bruh,"]
    suffixes = ["yo.", "cap.", "for real.", "bitch.", "yo."]
...
def reply_logic(text: str) -> str:
    ...
    if text == "help":
        return jesse("Commands: add <task>, done <task>, focus, today, list")
